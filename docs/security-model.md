...
- The effective provider selection in current code is controlled by `NODE_ENV`, not by a fully authoritative config contract. That mismatch is tracked in [docs/implementation-gaps.md](./implementation-gaps.md).
